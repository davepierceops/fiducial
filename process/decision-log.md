...
its own for methodology decisions [R0583, R0592, R1603]. An entry takes this
form, and carries no author field:
...
guarantees that the last entry holds the highest ID.
